          ...
          <AnimatePresence>
            {visibleServices.map((service, idx) => (
              <motion.div
                ...
                className="soft-card p-6 sm:p-8 cursor-pointer flex flex-col justify-between group"
              >
                <div>
        ...
        {selectedService && (
          <div id="it-modal-overlay" className="fixed inset-0 z-50 bg-charcoal/40 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
            <motion.div
              ...
              className="bg-bg border border-charcoal/10 w-full max-w-[calc(100vw-2rem)] sm:max-w-lg rounded-2xl sm:rounded-3xl shadow-2xl relative z-10 overflow-hidden"
            >
              {/* Header */}
