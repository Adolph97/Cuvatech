        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mb-24">
          <motion.div variants={fadeInUp} className="lg:col-span-7 space-y-8">
            ...
            <div className="pt-6 flex flex-col sm:flex-row gap-6">
              <motion.div whileHover={{ y: -5 }} className="flex-1 bg-white border border-charcoal/5 p-6 rounded-2xl shadow-sm">
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-5 space-y-8">
            {/* Mission Statement */}
            <motion.div whileHover={{ scale: 1.02 }} className="bg-primary/5 border border-primary/10 p-8 rounded-3xl relative overflow-hidden">
            ...
            {/* Vision Statement */}
            <motion.div whileHover={{ scale: 1.02 }} className="bg-white border border-charcoal/5 p-8 rounded-3xl shadow-lg shadow-charcoal/5 relative overflow-hidden">
              <div className="absolute right-3 top-3 opacity-10">
            ...
            {TEAM_MEMBERS.map((member) => (
              ...
              >
                ...
                <div className="p-10 space-y-5 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-6 border-t border-charcoal/5 flex items-center justify-between text-[10px] font-bold text-charcoal/20 uppercase tracking-widest">
